...
**Версия 1.2.1** · Десктопное приложение для Windows для управления салоном красоты «Ева-стиль».
...
1. Скачайте `eva-style-setup-1.2.1.exe` из [релизов на GitHub](https://github.com/nickeynnick/Eva-style/releases)
...
1. Скачайте `eva-style-1.2.1-portable.exe`
