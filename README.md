...
**Версия 1.4.2** · Десктопное приложение для Windows (Tauri) для управления салоном красоты «Ева-стиль».

Репозиторий: [github.com/nickeynnick/Eva-style](https://github.com/nickeynnick/Eva-style) · [Релиз v1.4.2](https://github.com/nickeynnick/Eva-style/releases/tag/v1.4.2)
...
1. Скачайте `eva-style-setup-1.4.2.exe` из [релизов на GitHub](https://github.com/nickeynnick/Eva-style/releases/tag/v1.4.2)
2. Запустите файл и следуйте инструкциям мастера установки
3. Запустите «Ева-стиль» с рабочего стола или из меню «Пуск»

### Портативная версия

1. Скачайте `eva-style-1.4.2-portable.exe`
